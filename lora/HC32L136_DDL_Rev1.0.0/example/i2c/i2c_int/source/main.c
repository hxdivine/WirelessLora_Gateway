...
static void I2c1CallBack(void)
{
    ...
    switch(u8State)
    {
        ...
        case 0x10:
            ...
            {
                I2C_WriteByte(I2C1,I2C_SLAVERD);
            }
            break;
        case 0x18:
            I2C_ClearFunc(I2C1,I2cStart_En);
...
int32_t main(void)
{
    ...
    Gpio_SetAfMode(GpioPortA, GpioPin11,GpioAf3);
    Gpio_SetAfMode(GpioPortA, GpioPin12,GpioAf3);
