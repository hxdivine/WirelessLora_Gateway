...
int32_t main(void)
{
    ...
    stcConfig.enGate   = LptGateEnable;      //Gate Enable
    ...
    stcConfig.enMD     = Lpt16bitFreeMode;   //无重载16位计数器/定时器
