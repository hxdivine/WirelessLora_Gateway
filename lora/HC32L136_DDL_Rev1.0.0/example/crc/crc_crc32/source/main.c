...
int32_t main(void)
{
    ...
    ///< CRC32 编码
    u32CrcResult =  CRC32_Get8(au8CrcTestData, u32TestDataLen);
    if(u32RefCrc32 == u32CrcResult)
    {
        u8TestFlag = Ok;
    }
    ...
    ///< CRC32 编码
    u32CrcResult =  CRC32_Get16((uint16_t  *)au8CrcTestData, u32TestDataLen/2);
    if(u32RefCrc32 == u32CrcResult)
    {
        u8TestFlag = Ok;
    }
    ...
    ///< CRC32 编码
    u32CrcResult =  CRC32_Get32((uint32_t  *)au8CrcTestData, u32TestDataLen/4);
    if(u32RefCrc32 == u32CrcResult)
    {
        u8TestFlag = Ok;
    }
