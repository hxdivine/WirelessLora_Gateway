...
#define ENC28J60CS_H	gpio_bit_set(GPIOB,GPIO_PIN_12);
#define ENC28J60CS_L	gpio_bit_reset(GPIOB,GPIO_PIN_12);

#define ENC28J60RST_H	gpio_bit_set(GPIOA,GPIO_PIN_4);
#define ENC28J60RST_L	gpio_bit_reset(GPIOA,GPIO_PIN_4);
